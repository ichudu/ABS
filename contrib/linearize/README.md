# Linearize
Construct a linear, no-fork, best version of the Absolute blockchain. The scripts
...
JSON-RPC server. Running `absoluted` or `absolute-qt -server` will be sufficient.
...
* `input`: absoluted blocks/ directory containing blkNNNNN.dat
