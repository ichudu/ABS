...
TRANSLATIONS += src/qt/locale/absolute_bg.ts \
                src/qt/locale/absolute_de.ts \
                src/qt/locale/absolute_en.ts \
                src/qt/locale/absolute_es.ts \
                src/qt/locale/absolute_fi.ts \
                src/qt/locale/absolute_fr.ts \
                src/qt/locale/absolute_it.ts \
                src/qt/locale/absolute_ja.ts \
                src/qt/locale/absolute_pl.ts \
                src/qt/locale/absolute_pt.ts \
                src/qt/locale/absolute_ru.ts \
                src/qt/locale/absolute_sk.ts \
                src/qt/locale/absolute_sv.ts \
                src/qt/locale/absolute_vi.ts \
                src/qt/locale/absolute_zh_CN.ts \
                src/qt/locale/absolute_zh_TW.ts
