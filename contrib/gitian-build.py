...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/absolute-community/gitian.signatures'])
    if not os.path.isdir('absolute-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/absolute-community/absolute.detached.signatures.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('absolute'):
        subprocess.check_call(['git', 'clone', 'https://github.com/absolute-community/absolute'])
