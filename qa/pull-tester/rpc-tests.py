...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs absolute_hash to pass
    'wallet-hd.py',
    'walletbackup.py',
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs absolute_hash to pass
    'llmq-chainlocks.py', # NOTE: needs absolute_hash to pass
    'llmq-simplepose.py', # NOTE: needs absolute_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs absolute_hash to pass
    'llmq-is-retroactive.py', # NOTE: needs absolute_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs absolute_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs absolute_hash to pass
